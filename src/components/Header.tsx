...
const Header = () => {
  ...
  return (
    <header className="bg-gradient-to-l from-emerald-500 via-emerald-600 to-emerald-700 shadow-2xl border-b-2 border-emerald-800 sticky top-0 z-50 backdrop-blur-md" dir="rtl">
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-4">
              <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-white/95 shadow-xl border-2 border-emerald-200 overflow-hidden backdrop-blur-sm hover:scale-105 transition-all duration-300">
                ...
                />
                <Coffee className="h-7 w-7 text-emerald-600 coffee-fallback" style={{display: 'none'}} />
              </div>
              <div className="text-right">
                <h1 className="text-2xl font-black text-white drop-shadow-2xl font-cairo tracking-wide">
                  موريسكو كافيه
                </h1>
                <p className="text-sm text-emerald-100 font-semibold font-cairo">نظام الإدارة الذكي</p>
              </div>
            </div>
